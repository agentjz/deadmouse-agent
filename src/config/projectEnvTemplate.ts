export function buildProjectEnvTemplate(example: boolean): string {
  ...
  return [
    ...
    "KITTY_YIELD_AFTER_TOOL_STEPS=32",
    "KITTY_MAX_TOOL_ITERATIONS=20",
    "KITTY_MAX_CONTINUATION_BATCHES=16",
    "KITTY_PROVIDER_RECOVERY_MAX_ATTEMPTS=6",
    "KITTY_PROVIDER_RECOVERY_MAX_ELAPSED_MS=120000",
    "KITTY_MANAGED_TURN_MAX_SLICES=16",
    "KITTY_MANAGED_TURN_MAX_ELAPSED_MS=900000",
    "",
    "# Tool IO budgets",
    "KITTY_MAX_READ_BYTES=120000",
    "KITTY_MAX_SEARCH_RESULTS=80",
    "KITTY_COMMAND_STALL_TIMEOUT_MS=30000",
    "KITTY_COMMAND_MAX_RETRIES=1",
    "KITTY_COMMAND_RETRY_BACKOFF_MS=1500",
    "KITTY_SHOW_REASONING=true",
    "",
    "# Agent profile settings",
    "# Built-in agent profiles: intp | grok | caveman",
    "KITTY_PROFILE=intp",
    "",
    "# Provider / model settings",
    "# Provider preset 1: GPT-5.4",
    ...
    "",
    "# Provider preset 2: DeepSeek official V4",
    ...
    "",
    "# Provider preset 3: SiliconFlow + DeepSeek V3.2",
